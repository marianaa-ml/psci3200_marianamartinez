...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
american_aid_untouched <- read_xlsx('/Users/mariana/Desktop/datasets/AmericanActiveProjects.xlsx')
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
wb_raw <- read_excel('/Users/mariana/Desktop/datasets/IBRD_IDA Summary (Lending).xlsx')
head(wb_raw)
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
unemployment <- read_csv('/Users/mariana/Desktop/datasets/unemployment.csv')
head(unemployment)
```
